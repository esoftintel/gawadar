          	...
          	<div class="row">
          		<div class="col-md-12 ftco-animate">
          			<div class="single-slider owl-carousel">
          				<div class="item">
          					<div class="hotel-img" style="background-image: url('{{ asset('userassets/images/hotel-2.jpg')}}');"></div>
          				</div>
          				<div class="item">
          					<div class="hotel-img" style="background-image: url('{{ asset('userassets/images/hotel-3.jpg')}}');"></div>
          				</div>
          				<div class="item">
          					<div class="hotel-img" style="background-image: url('{{ asset('userassets/images/hotel-4.jpg')}}');"></div>
          				</div>
          			</div>
          		</div>
          			...
          			<div class="row">
          				<div class="col-md-4">
				    				<div class="destination">
				    					<a href="hotel-single.html" class="img img-2" style="background-image: url('{{ asset('userassets/images/room-4.jpg')}}');"></a>
				    					<div class="text p-3">
				    						<div class="d-flex">
				    							<div class="one">
				    			...
				    			<div class="col-md-4">
				    				<div class="destination">
				    					<a href="hotel-single.html" class="img img-2" style="background-image: url('{{ asset('userassets/images/room-5.jpg')}}');"></a>
				    					<div class="text p-3">
				    						<div class="d-flex">
				    							<div class="one">
						    						<h3><a href="hotel-single.html">Hotel, Italy</a></h3>
				    			...
				    			<div class="col-md-4">
				    				<div class="destination">
				    					<a href="hotel-single.html" class="img img-2" style="background-image: url('{{ asset('userassets/images/room-6.jpg')}}');"></a>
				    					<div class="text p-3">
				    						<div class="d-flex">
				    							<div class="one">
						    						<h3><a href="hotel-single.html">Hotel, Italy</a></h3>
          		...
          		<div class="col-md-12 hotel-single ftco-animate mb-5 mt-5">
          			...
          			<div class="row">
          				<div class="col-md-4">
				    				<div class="destination">
				    					<a href="hotel-single.html" class="img img-2" style="background-image: url('{{ asset('userassets/images/hotel-1.jpg')}}');"></a>
				    					<div class="text p-3">
				    						<div class="d-flex">
				    							<div class="one">
						    						<h3><a href="hotel-single.html">Hotel, Italy</a></h3>
				    			...
				    			<div class="col-md-4">
				    				<div class="destination">
				    					<a href="hotel-single.html" class="img img-2" style="background-image: url('{{ asset('userassets/images/hotel-2.jpg')}}');"></a>
				    					<div class="text p-3">
				    						<div class="d-flex">
				    							<div class="one">
						    						<h3><a href="hotel-single.html">Hotel, Italy</a></h3>
				    			...
				    			<div class="col-md-4">
				    				<div class="destination">
				    					<a href="hotel-single.html" class="img img-2" style="background-image: url('{{ asset('userassets/images/hotel-3.jpg')}}');"></a>
				    					<div class="text p-3">
				    						<div class="d-flex">
				    							<div class="one">
						    						<h3><a href="hotel-single.html">Hotel, Italy</a></h3>
