<footer class="ftco-footer ftco-bg-dark ftco-section">
  ...
  Copyright &copy;<script>document.write(new Date().getFullYear());</script> All rights reserved | This Website Made  <i class="icon-heart" aria-hidden="true"></i> by <a href="https://logicssol.com" target="_blank">Logicssol</a>
