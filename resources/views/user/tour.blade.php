	...
	<body>
	<?php $index=$hotel=$contact=$blog=$about=$blogSingle=$hotelSingle=$home='nav-item';
          $tour='nav-item active';
  ?>
    
  @include('user.templates.navbar')
    
    <div class="hero-wrap js-fullheight" style="background-image: url('{{ asset('userassets/images/bg_3.jpg')}}');">
      <div class="overlay"></div>
      <div class="container">
        <div class="row no-gutters slider-text js-fullheight align-items-center justify-content-center" data-scrollax-parent="true">
          <div class="col-md-9 ftco-animate text-center" data-scrollax=" properties: { translateY: '70%' }">
            <p class="breadcrumbs" data-scrollax="properties: { translateY: '30%', opacity: 1.6 }"><span class="mr-2"><a href="/user/">Home</a></span> <span>Tour</span></p>
          ...
          <div class="col-lg-9">
          	<div class="row">
          		<div class="col-md-4 ftco-animate">
		    			...
		    			<div class="col-md-4 ftco-animate">
		    				<div class="destination">
		    					<a href="#" class="img img-2 d-flex justify-content-center align-items-center" style="background-image: url('{{ asset('userassets/images/destination-6.jpg')}}');">
		    						<div class="icon d-flex justify-content-center align-items-center">
    							<span class="icon-search2"></span>
    						</div>
		    					</a>
