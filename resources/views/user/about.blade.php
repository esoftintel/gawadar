...
@include('user.templates.header')
  <body>
		<?php
		$blog=$blogSingle=$contact=$hotel=$hotelSingle=$index=$tour=$home='nav-item';
          $about='nav-item active';
		?>
    
 @include('user.templates.navbar')
    
    <div class="hero-wrap js-fullheight" style="background-image: url('{{ asset('userassets/images/bg_2.jpg')}}');">
      <div class="overlay"></div>
      <div class="container">
        <div class="row no-gutters slider-text js-fullheight align-items-center justify-content-center" data-scrollax-parent="true">
          <div class="col-md-9 text-center ftco-animate" data-scrollax=" properties: { translateY: '70%' }">
            <p class="breadcrumbs" data-scrollax="properties: { translateY: '30%', opacity: 1.6 }"><span class="mr-2"><a href="/user/">Home</a></span> <span>About</span></p>
    ...
    <section class="ftco-section">
    	<div class="container">
    		<div class="row d-md-flex">
	    		<div class="col-md-6 ftco-animate img about-image" style="background-image: url('{{ asset('userassets/images/about.jpg')}}');">
	    		</div>
