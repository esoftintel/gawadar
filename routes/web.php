...
Route::prefix('/user')->group(function() {
    Route::get('/','UserModelController@index');
    Route::get('/about','UserModelController@about');
    Route::get('/contact','UserModelController@contact');
    Route::get('/blog','UserModelController@blog');
    Route::get('/hotel','UserModelController@hotel');
    Route::get('/tour','UserModelController@tour');
